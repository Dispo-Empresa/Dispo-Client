...
function Detail(props) {
    ...
    const modal = () => {
        switch (path) {
            case "/products" :
              return <ProductDetails modalType={props.modalType} productId={props.rowId} />;
            case "/brands" :
              return <BrandDetails modalType={props.modalType} brandId={props.rowId} />
            case "/providers" :
              return <ProviderDetails modalType={props.modalType} providerId={props.rowId} />
            default:
              return null;
        };
    }
