...
export default function SignInCard() {
  ...
  useEffect(() => {
    ...
    const emailSigninCookie = cookies.get("emailSignin");
    const passwordSigninCookie = cookies.get("passwordSignin");
  ...
  const SignIn = () => {
    ...
    const emailSigninCookie = decryptData(cookies.get("emailSignin"));
    const passwordSigninCookie = decryptData(cookies.get("passwordSignin"));
    ...
    .then(async function(res){
      ...
      if(keepConnected && (!emailSigninCookie && !passwordSigninCookie)){
        cookies.set("emailSignin", encryptData(emailRequest), { path: "/" });
        cookies.set("passwordSignin", encryptData(passwordRequest), { path: "/" });
      }
